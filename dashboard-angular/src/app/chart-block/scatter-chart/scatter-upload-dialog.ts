...
@Component({
  selector: 'app-scatter-upload-dialog',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
  ...
  templateUrl: './scatter-upload-dialog.html',
...
export class ScatterUploadDialogComponent {
  ...
  constructor(private dialogRef: MatDialogRef<ScatterUploadDialogComponent>) {}
  ...
  onUpload() {
    if (this.selectedFile && this.selectedXAxis && this.selectedYAxis) {
